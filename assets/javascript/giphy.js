$(document).ready(function(){
    ...
    var displayedButtons = ["Dog", "cat", "rabbit", "hamster", "skunk", "goldfish", "hedgehog", "hermit crab", "chicken", "frog", "turtle", "chinchilla", "bird", "goat", "sheep", "giraffe", "gorilla"];
        ...
        function displayImg(){
            ...
            $.ajax({
                ...
                for(var j = 0; j < limit; j++) {    
                    ...
                    var displayDiv = $("<div>");
                    displayDiv.addClass("imageholder");
        ...
        $(document).on("click", ".gif", imagePlay);
    });